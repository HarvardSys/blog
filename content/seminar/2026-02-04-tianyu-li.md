...
summary = "As the cloud evolves in capability, it has also become increasingly complex and difficult to program. New abstractions are necessary to ensure next-generation cloud applications are correct, simple, and efficient. In this talk, Tianyu Li will describe Resilient Composition, a new abstraction that ensures fault-tolerance in applications composed from independent, distributed components."
draft = false
+++
